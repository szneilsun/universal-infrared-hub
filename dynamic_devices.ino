...
String pageHeader() {
  return F("<!doctype html><html lang='zh-CN'><meta name='viewport' content='width=device-width,initial-scale=1'>"
           ...
           "*{box-sizing:border-box}body{font-family:-apple-system,BlinkMacSystemFont,'PingFang SC','Noto Sans SC',sans-serif;max-width:780px;margin:0 auto;padding:24px 16px 44px;color:var(--ink);background:radial-gradient(ellipse at 88% 0,#dce9df 0,transparent 43%),radial-gradient(ellipse at 0 35%,#f8faf4 0,transparent 38%),var(--canvas);letter-spacing:.01em}"
           ".hero{padding:28px 24px 25px;border-radius:22px;background:linear-gradient(132deg,rgba(255,255,251,.92),rgba(224,235,225,.85));border:1px solid rgba(255,255,255,.8);box-shadow:0 12px 32px rgba(55,76,62,.09);position:relative;overflow:hidden}.hero:after{content:'';position:absolute;width:190px;height:190px;border:1px solid rgba(91,125,102,.2);border-radius:50%;right:-80px;top:-95px;box-shadow:-25px 27px 0 -1px rgba(91,125,102,.09)}"
           ...
           "section{border:1px solid var(--line);border-radius:18px;padding:19px 18px;margin:15px 0;background:var(--card);box-shadow:0 6px 20px rgba(45,65,52,.055)}section h2{font-family:ui-serif,Georgia,'Songti SC',serif;font-size:20px;font-weight:600;letter-spacing:.02em;margin:0 0 10px}section h2 small{font-family:-apple-system,BlinkMacSystemFont,'PingFang SC',sans-serif;color:var(--muted);font-size:12px;font-weight:500;letter-spacing:0}.muted{color:var(--muted);font-size:13px;line-height:1.65}.ok{color:var(--sage-dark);font-size:13px;font-weight:600}"
           "form{margin:8px 0}button{appearance:none;background:var(--sage-dark);color:#fff;border:0;border-radius:9px;padding:9px 12px;margin:3px 4px 3px 0;font:600 13px -apple-system,BlinkMacSystemFont,'PingFang SC',sans-serif;letter-spacing:.01em;box-shadow:0 2px 5px rgba(51,76,61,.13)}button:active{transform:translateY(1px);background:#415b4d}input,select{font:14px -apple-system,BlinkMacSystemFont,'PingFang SC',sans-serif;color:var(--ink);background:#fbfcf9;border:1px solid #cbd8cc;border-radius:8px;padding:9px 10px;margin:3px 4px 3px 0;max-width:100%}input[type=checkbox]{accent-color:var(--sage-dark);vertical-align:middle}label{font-size:13px;color:var(--muted);white-space:nowrap}a{color:var(--sage-dark);font-weight:600;text-decoration:none}"
