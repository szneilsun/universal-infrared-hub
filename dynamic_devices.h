...
constexpr uint8_t MAX_DEVICE_ACTIONS = 12;
constexpr uint32_t DEVICE_MAGIC = 0x49524432;  // "IRD2"
constexpr uint16_t DEVICE_SCHEMA_VERSION = 1;

enum UserDeviceType : uint8_t { USER_SWITCH, USER_FAN, USER_TELEVISION };
enum UserAction : uint8_t {
  ...
  ACTION_DOWN, ACTION_LEFT, ACTION_RIGHT, ACTION_SELECT
};
